...
$page_description = 'Курс підготовки інструкторів пілатесу на Mat і Reformer: практика на професійному обладнанні Cadillac, Reformer і Wall Unit, іспит і сертифікат. Львів, студія «Пілатес Львів».';
...
$tariffs = [
  ...
  ['Reformer: обладнання', '10 тижнів, 80 годин', [
    ...
    ['Обладнання', 'Reformer, Cadillac, Wall Unit'],
    ['Іспит', 'Входить у вартість'],
  ], 19000, 'reformer'],
...
$benefits = [
  ...
  ['directions/2.jpeg',  'Малі групи',             'До восьми людей на маті й до шести на обладнанні'],
...
$reviews = [
  ...
  ['Вчилася на реформері вже після Mat. Практики багато — ми не слухали лекції, ми весь час стояли біля обладнання і переставляли пружини.', 'Христина', 'випускниця курсу Reformer', '7.jpg'],
];
...
$faq = [
  ...
  ['Можна одразу на Reformer, без Mat?',
   'Тільки якщо ви вже викладаєте пілатес і закрили базу деінде. Інакше ні: на обладнанні важко пояснити людині рух, який ви самі не вмієте розкласти на маті.'],
...
$cta_img_alt = 'Заняття курсу біля обладнання у залі студії';
...
$seo_text  = <<<HTML
  <p>
    ...
    і анатомія руху, Reformer — пружинний опір і робота на обладнанні,
  ...
  <p>
    ...
    з перших у Львові студій з професійним обладнанням для пілатесу.
