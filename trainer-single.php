...
// а не темним банером — лягати поверх нього нема чого
...
$cta_text  = 'Передзвонимо, підберемо час у розкладі Галини і відповімо на питання. Отримайте стартову пропозицію на перше заняття.';
