...
$page_description = 'Тренери студії: пілатес на Cadillac і Reformer, йога, танці, функціональне відновлення. Досвід, напрямки, локації.';
...
$team = [
  ['Галина',   'halyna',     'Пілатес на обладнанні',  'pilates',  'Коли мій клієнт каже, що в нього більше не болить спина, — це найбільша втіха для мене', '12 років'],
  ['Оксана',   'oksana',     'Пілатес на обладнанні',  'pilates',  'Я допомагаю людям повернути здоров’я та радість життя', '8 років'],
  ['Сюзанна',  'suzanna',    'Пілатес на обладнанні',  'pilates',  'Ось вже 10 років я займаюсь тим, що повертаю людям радість руху', '10 років'],
  ['Ірина',    'iryna',      'Пілатес на обладнанні',  'pilates',  'Повернути людині красиву поставу та здорове тіло — це те саме, що повернути віру в себе', '7 років'],
...
$cta_text  = 'Подзвоніть — спитаємо, що болить і чого хочете, і підберемо тренера під це. Стартову пропозицію отримаєте в будь-якому разі.';
...
$seo_text  = <<<HTML
  <p>
    У студії працюють семеро тренерів. Четверо ведуть пілатес на обладнанні
    — на Cadillac, Reformer і Wall Unit; решта — йогу, танці
