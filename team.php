...
$team = [
  ['Галина',   'halyna',     'Пілатес на тренажерах',  'pilates',  'Коли мій клієнт каже, що в нього більше не болить спина, — це найбільша втіха для мене', '12 років'],
  ['Оксана',   'oksana',     'Пілатес на тренажерах',  'pilates',  'Я допомагаю людям повернути здоров’я та радість життя', '8 років'],
  ['Сюзанна',  'suzanna',    'Пілатес на тренажерах',  'pilates',  'Ось вже 10 років я займаюсь тим, що повертаю людям радість руху', '10 років'],
  ['Ірина',    'iryna',      'Пілатес на тренажерах',  'pilates',  'Повернути людині красиву поставу та здорове тіло — це те саме, що повернути віру в себе', '7 років'],
...
$seo_text  = <<<HTML
  <p>
    У студії працюють семеро тренерів. Четверо ведуть пілатес на тренажерах
