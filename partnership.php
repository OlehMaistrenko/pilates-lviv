...
$benefits = [
  ['gallery/2.jpg',     'Повний набір обладнання', 'Cadillac, Reformer і Wall Unit в одному залі — єдина така студія у Львові'],
...
$offers = [
  ...
  ['corporate', 'Знижки для співробітників',
   'Реєструємо компанію як партнера: стартова пропозиція для команди зі знижкою і постійна знижка на абонементи для всіх співробітників.',
   [['Стартова', 'зі знижкою'], ['Далі', 'знижка на абонементи'], ['Пакет занять', 'на всю команду']], null],
  ...
  ['brand', 'Бренди, зйомки, події',
   ...
   [['Час', 'у вікнах між заняттями'], ['Простір', 'зал із обладнанням']], null],
];
