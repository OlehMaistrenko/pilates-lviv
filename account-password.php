 ...
 * заповнювати — код і новий пароль; from=account міняє там «Надіслати код
 * ще раз» так, щоб воно лишалось у кабінетному флоу.
 *
...
<?php if (account_is_logged()): ?>
  ...
  <p class="text--sm text--muted">
    ...
    задасте новий. Поточний пароль вводити не треба.
  </p>
