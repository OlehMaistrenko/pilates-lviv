...
<!-- ============================================================
     02 · Карта — той самий блок, що на contacts.php/locations.php,
     з відкритим одразу цим залом ($vendor_map виставляє сам партіал)
     ============================================================ -->
<?php
$map_active = $loc_slug;
...
<!-- ============================================================
     03 · Контакти й форма — телефон саме цієї зали; локація йде в
     прихованому полі, щоб запит одразу прийшов на потрібний зал
     ============================================================ -->
<?php
$form_title  = 'Питання про залу на ' . $loc['label'];
$form_text   = 'Відповідаємо в робочий час. Якщо питання про запис — скажіть, коли вам зручно, і назвемо вільні вікна саме на цій локації.';
$form_phone      = $loc['phone'];
$form_phone_href = $loc['phone_href'];
$form_hidden = ['location' => $hall];
// Єдине мохове поле сторінки: банер тут фото, а не колір, тож форма бере
// на себе темний акцент і відділяє карту від слайдера тренерів.
$form_class  = 'section--moss patterned on-dark';
include 'partials/contact-form.php';
?>

<!-- ============================================================
     04 · Тренери цієї локації — той самий слайдер, що на головній
     ============================================================ -->
<?php
...
<!-- ============================================================
     05 · Галерея зали — той самий свайпер, що на головній/тренері
     ============================================================ -->
<?php
...
$cta_text  = 'Отримайте стартову пропозицію: тренер подивиться, як ви рухаєтесь, і підбере формат.';
$cta_modal = 'booking?location=' . $hall;
include 'partials/cta.php';
?>

<!-- ============================================================
     07 · FAQ — про цю локацію
     ============================================================ -->
<?php
$faq_items = [
