...
$cta_text      = 'Отримайте стартову пропозицію: спробуєте обладнання, поговорите з тренером і вирішите самі.';
...
$seo_text  = <<<HTML
  ...
  <p>
    ...
    людей, щоб тренер бачив техніку кожного. Перше заняття — не урок, а екскурсія:
