...
$posts = [
  ...
  ['Cadillac: навіщо студії обладнання, схоже на ліжко з рамою', 'cadillac',
  ...
  ['Пружинний опір замість вільної ваги: чому ми працюємо саме так', 'spring-method',
   'Як влаштований опір на Cadillac і Reformer і чим він відрізняється від класичного пілатесу на маті.',
...
<!-- ============================================================
     ...
     (.hero--page): під ним одразу список статей. Замість відео — кадр:
  ...
  <div class="split__grid">
    ...
    <div class="split__body" data-anim="parallax" data-parallax="4">
      ...
      <p class="text--lead text--muted" data-reveal>
        Отримаєте стартову пропозицію: подивитись зал, поговорити з тренером
        і спробувати обладнання.
      </p>
