...
$path = [
  ['10', 'Спина менше втомлюється за столом, поставу тримати легше без нагадувань. Вправи з першого заняття вже робите на важчій пружині.'],
  ['20', 'Різницю помічають інші: рівніші плечі, інша хода. Ви знаєте вправи по назвах і самі відчуваєте, коли пружина стоїть не та.'],
  ['30', 'Рухи, які на старті збирали по частинах, ідуть одним цілим. Біль, з яким прийшли, — уже не причина приходити.'],
];
...
<!-- ============================================================
     ...
     10 · 20 · 30 занять. Ліворуч одна велика цифра-одометр, яку крутить
     скрол (sticky + scrub), праворуч тексти; активний — у фокусі.
     ============================================================ -->
  ...
  <div class="container">
    ...
    <div class="path__grid">
      <!-- одометр: три цифри в масці, скрол зсуває стовпчик (js/main.js,
           data-anim="odometer"). На мобілці й при reduced-motion прихований —
           там цифру показує кожен крок сам. -->
      <div class="path__counter" aria-hidden="true">
...
<!-- ============================================================
     05 · Чому саме ми — одна теза, цифри, три аргументи з діючого сайту
     ============================================================ -->
...
<!-- ============================================================
     06 · Про студію — історія засновниці, дослівно з діючого сайту
     ============================================================ -->
...
<!-- ============================================================
     07 · Галерея — зал як він є; розміри кадрів різні навмисно
     ============================================================ -->
...
<!-- ============================================================
     08 · Тренери — портрет-арка, ім’я, напрямок і власна цитата
     ============================================================ -->
...
<!-- ============================================================
     09 · Відгуки — третє й останнє мохове поле перед футером
     ============================================================ -->
...
<!-- ============================================================
     11 · SEO-текст — вузький стовпчик, читається як довідка, не як банер
     ============================================================ -->
