...
// Реальна тільки перша адреса (Романицького, 24а — з діючого сайту).
// TODO: Брюховичі й Сихів — адреси й описи вигадані, замінити на справжні,
// коли клієнт дасть дані по двох нових залах.
$locations = [
  ['Чупринки',  'вул. Б. Романицького, 24а', 'Cadillac, два Reformer і Wall Unit. Група — до 8 людей, є роздягальня з душем.', 'gallery/1.jpeg'],
  ['Брюховичі', 'вул. Сагайдачного, 7',      'Два Reformer і зал для матів на 12 килимків. Вікна на сосни, поруч є де лишити авто.', 'gallery/2.jpeg'],
  ['Сихів',     'просп. Червоної Калини, 62', 'Reformer, Wall Unit і окрема кімната для персональних занять. Три хвилини від трамвая.', 'gallery/6.jpeg'],
];
  ...
  <div class="locations__stage">
    ...
    <div class="locations__arch">
      ...
      <?php foreach ($locations as $i => $l): ?>
        <!-- --bg-shot читає лише мобільна розкладка: там фонових шарів нема,
             тож кадр-арку показує сама панель (css/styles.css, ::before) -->
        <article class="locations__panel<?= $i ? '' : ' is-active' ?>"
                 style="--bg-shot: url('assets/img/<?= $l[3] ?>')">
          <?php if ($i === 0): ?>
