...
$faq = [
  ['Я ніколи не займався пілатесом. З чого почати?',
   'Почніть зі стартової пропозиції: дивитесь зал, пробуєте обладнання, тренер дивиться, як ви рухаєтесь. Якщо є біль у спині чи травми — краще спершу консультація фізіолога, вона допоможе підібрати напрямок.'],
  ['Що взяти з собою?',
...
$advantages = [
  ...
  ['Стартова пропозиція',  'Приходите подивитись зал і спробувати обладнання. Далі вирішуєте самі, без абонемента наперед.', 'location-1/6.jpg'],
];
...
<!-- ============================================================
     ...
     ============================================================ -->
<?php
$cta_title     = 'Отримайте <span class="nowrap">стартову</span> пропозицію';
...
$seo_text  = <<<HTML
  ...
  <p>
    ...
    це стартова пропозиція: подивитись зал, спробувати обладнання, поговорити з
